...
func SetupGreenHillBackground(sprites core.Sprites, renderables []interfaces.Renderable) []interfaces.Renderable {
	renderables = append(renderables, engine.BuildCachedLayer("GreenHillStaticBackground", []engine.CachedSpriteDraw{
		{
...
func SetupGreenHillForeground(sprites core.Sprites, renderables []interfaces.Renderable) []interfaces.Renderable {
	renderables = append(renderables, engine.BuildCachedLayer("GreenHillStaticForeground", []engine.CachedSpriteDraw{
		{
			Sprite:   sprites.Sprites["Flower1"],
			Frame:    sprites.Sprites["Flower1"].GetFrame(0),
			Position: core.Point{X: 154, Y: 90},
		},
		{
			Sprite:   sprites.Sprites["Flower2"],
			Frame:    sprites.Sprites["Flower2"].GetFrame(0),
			Position: core.Point{X: -5, Y: 115},
		},
		{
			Sprite:   sprites.Sprites["Flower2"],
			Frame:    sprites.Sprites["Flower2"].GetFrame(0),
			Position: core.Point{X: 220, Y: 115},
		},
		{
			Sprite:   sprites.Sprites["Flower2"],
			Frame:    sprites.Sprites["Flower2"].GetFrame(0),
			Position: core.Point{X: 250, Y: 115},
		},
		{
